...
$config = [
    ...
    'modules' => [
        ...
        'pochta' => [
            'class' => 'app\modules\pochta\Module',
        ],
    ],
    'components' => [
        'request' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '/<module:pochta>' => 'pochta/main/index',
                '/<module:pochta>/<action>' => 'pochta/main/<action>',
                '/<module:interface-app>' => 'interface-app/main/index',
                '/<module:interface-app>/<controller>/<action>' => 'interface-app/<controller>/<action>',
